TString dir="PUplotst1";
TString format="ZB.png";
...
TF1 *langaufit(TH1D *his, Double_t *fitrange, Double_t *startvalues, Double_t *parlimitslo, Double_t *parlimitshi, Double_t *fitparams, Double_t *fiterrors, Double_t *ChiSqr, Int_t *NDF)
{
	...
	his->Fit(FunName,"RBEM");   // fit within specified range, use ParLimits, do not plot
...
TF1 *fitting(TH1D *hist){
	...
	Double_t chisqr;
	Int_t    ndf;
	TF1 *fitfun = langaufit(hist,fr,sv,pllo,plhi,fp,fpe,&chisqr,&ndf);
